...
class InverseKinematicsNumeric:
    def __init__(self,) -> None:
        ...
        ik = self.compute_solution(q, FL_foot_target_position, FR_foot_target_position, 
                                   RL_foot_target_position, RR_foot_target_position)
        self.fun_compute_solution = cs.Function('fun_ik', [q, FL_foot_target_position, FR_foot_target_position, RL_foot_target_position, RR_foot_target_position], [ik])
...
if __name__ == "__main__":
    ...
    solution = ik.fun_compute_solution(initial_q, FL_foot_target_position, FR_foot_target_position, 
                               RL_foot_target_position, RR_foot_target_position)
